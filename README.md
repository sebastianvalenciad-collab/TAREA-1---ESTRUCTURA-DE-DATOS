...
Una vez ejecutado el programa escribimos 1.
Luego nos pediran el nombre de la categoria e ingresamos nuestra respuesta.
...
Luego de ingresar una categoria es posible eliminarla, para esto primero escribimos 2.
Una vez dentro de la funcionalidad, escribimos el nombre de la categoria que deseamos eliminar y hacemos enter.
...
Tambien podemos ver cuales son las categorias que hemos ingresado, para esto seleccionamos la opcion 3.
...
Para registrar un pendiente, debemos seleccionar la opcion 4.
Luego nos pedira la descripcion de la tarea que queremos hacer y la categoria a la cual pertenece la tarea, despues solo hacemos enter y se guardara.
...
Para vaciar la lista de tareas, seleccionamos la opcion 5.
Luego el programa eliminara la tarea que lleva mas tiempo sin hacer, ya que esta ya fue atendida.
...
Para poder ver todas las tareas pendientes de una categoria especifica, seleccionamos la opcion 7.
Primero el programa nos mostrara todas las categorias disponibles y nos pedira que ingresemos el nomnbre de la categoria que deseamos filtrar.
